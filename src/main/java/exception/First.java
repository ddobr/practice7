...
public class First {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Поймано исключение при работе с null: " + e.getMessage());
        }

        try {
            tryToCreateFunnyArray();
        } catch (NegativeArraySizeException e) {
            System.out.println("Поймано исключение при создании массива с отрицательным размером: " + e.getMessage());
        }

        try {
            searchSomethingOutString();
        } catch (StringIndexOutOfBoundsException e) {
            System.out.println("Поймано исключение при попытке доступа к символу за пределами строки: " + e.getMessage());
        }
